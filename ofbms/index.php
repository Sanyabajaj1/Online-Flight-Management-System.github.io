...
#grading {
    background: linear-gradient(1deg, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.8)), url('images/o.jpg');
    width: 100%;
}
...
<section id="grading">
    <div class="container p-5" style="font-family:Serif">
        <div class="row p-5">
            <div class="col-6  text-primary pt-3">
                <strong>: : FLIGHT TALKS </strong>
                <p class="">
                    Aviation provides the only rapid worldwide transportation network, which makes it essential for
                    global business,economic growth, creates jobs, and facilitates international trade and tourism.</p>
            ...
            <div class="col-6">
                <div class="row row-cols-md-2 row-cols-sm-1 rol-cols-xs-1 row-cols-lg-2 g-3">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title fs-2 text-primary"> <strong>1800+</strong></h5>
...
<section>
    <div class="container mt-5">
        <p class="card card-body card-text text-primary" style="font-family:Serif">Airline tickets are important
            ...
            the passenger and the flight that they will take. The ticket is exchanged for a boarding pass during the
            check-in process, and this gives the passengers permission to board the plane.
        ...
        <p class="card card-body card-text text-primary" style="font-family:Serif">It provides users with a wide range
            ...
            suitable flight for their needs.</p>
