...
#grading {
    background: linear-gradient(1deg, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.8)), url('assets/images/op2.jpg');
    width: 100%;
}
...
#grading {
    background: linear-gradient(1deg, rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.4)), url('assets/images/op2.jpg');
...
<section id="grading">
    <div class="container p-5" style="font-family:Serif">
        <div class="row p-5">
            <div class="col-6  text-light pt-3">
                <strong>FLIGHT TALKS </strong>
                <p class="">
                Experience the joy of travel with our online airline service! We are dedicated to making your journey a seamless and unforgettable one. Whether you're jetting off for a well-deserved vacation or embarking on a business trip, we've got you covered. Enjoy the convenience of booking your flights from the comfort of your own home, with our user-friendly online platform. 
                Fly with us and discover a world of possibilities, where exceptional service meets affordable prices. So, why wait? Book your next adventure with us today and let us take you to new heights!
                Reach with us to reach your destination.</p>

                <button type="button" class="btn button1 "><span>CONTACT NOW</span></button>
            </div>
            <div class="col-6">
                <div class="row row-cols-md-2 row-cols-sm-1 rol-cols-xs-1 row-cols-lg-2 g-3">
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title fs-2 text-primary"> <strong>5900+</strong></h5>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title fs-2 text-primary"> <strong>16000+</strong></h5>
                                <p class="card-text"><strong>Happy Clients</strong></p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title fs-2 text-primary"> <strong>180+</strong></h5>
                                <p class="card-text"><strong>Qualified Pilots</strong></p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title fs-2 text-primary"> <strong>20+</strong> </h5>
...
<section>
    <div class="container mt-5">
        <p class="card card-body card-text text-primary" style="font-family:Serif">Airline tickets are important
            documents that confirm a passenger has a seat on a flight. The ticket includes important information about
            the passenger and the flight that they will be taking. The ticket is exchanged for a boarding pass during the
            check-in process, and this gives the passengers permission to board on the flight.

        </p>
        <p class="card card-body card-text text-primary" style="font-family:Serif">It provides users with a wide range
            of options, including different airlines, flight times, and prices, enabling them to select the most
            suitable flight as per their needs.</p>
        <p class="card card-body card-text text-primary" style="font-family:Serif">
            The system often incorporates advanced features such as filters for specific preferences (e.g., non-stop
            flights, preferred airlines), seat selection, and the ability to add additional services like baggage
            allowance or in-flight meals.
        </p>
    </div>
    </seection>
    <style>
  ...
  display:block;
    ...
    <footer class="">
        <em>
            <h5 class="text-dark text-center p-0 brand">
